        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                    placeSearch.selectedPlace.image,
                  ),
                  fit: BoxFit.cover,
                ),
              ),
            ...
            Padding(
              ...
              child: Text(
                placeSearch.selectedPlace.name,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    '${placeSearch.selectedPlace.rating}',
                    style: TextStyle(
                      fontSize: 18,
                  ...
                  Text(
                    '후기 ${placeSearch.selectedPlace.reviewCount}개',
                    style: TextStyle(
                      fontSize: 18,
                      color: kMainColor,
                    ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        '${placeSearch.selectedPlace.location}',
                    ...
                    children: [
                      Text.rich(
                        TextSpan(children: <TextSpan>[
                          TextSpan(
                            text: '${placeSearch.selectedPlace.price}',
                            style: TextStyle(
                              color: kMainColor,
                    ...
                    child: Container(
                      child: Text.rich(
                        TextSpan(children: <TextSpan>[
                          ...
                          TextSpan(
                            text: '  ${placeSearch.selectedPlace.openHour}간',
                  ...
                  Container(
                    child: Text.rich(
                      TextSpan(children: <TextSpan>[
                        ...
                        TextSpan(
                          text: placeSearch.selectedPlace.type,
                          style: TextStyle(fontSize: 14, color: Colors.grey),
                        ),
                      ]),
                    ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    child: Text(
                      placeSearch.selectedPlace.description,
